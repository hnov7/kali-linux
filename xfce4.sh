...
echo -e "\e[31m\n Pemasangan Kali Linux bisa di browser lur, Kau akses aja https://\$ip:$web_vnc_port\e[0m"
echo -e " Jangan lupa buka in port TCP $web_vnc_port kalo kau punya firewalled host.".
EOF
